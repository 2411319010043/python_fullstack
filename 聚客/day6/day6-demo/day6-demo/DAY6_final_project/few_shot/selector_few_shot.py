...
examples = [
    ...
    {"question":"什么是Chain?",
     "definition":"Chain 是 LangChain 中将多个步骤按顺序连接起来的执行流程。",
     "usage":"用于把 Prompt、模型、工具和数据处理步骤组合起来，完成复杂任务。",
     "example":"使用 Chain 可以实现“先检索文档内容，再让模型总结答案”的问答流程。"},
...
# 把多个示例（examples）按照指定格式自动拼接到 Prompt 中，作为 Few-shot（少样本）提示词的一部分。
